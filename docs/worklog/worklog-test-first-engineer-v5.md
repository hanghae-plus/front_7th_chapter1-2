...
- 산출물: src/__tests__/recurring-events.integration.spec.tsx (통합 테스트 6개 추가)
...
- src/__tests__/recurring-events.integration.spec.tsx (통합 테스트 - 6개 테스트 추가)
- src/__tests__/recurring-events.integration.spec.tsx:33-36 (navigateMonth 헬퍼 함수)
