...
- 산출물:
  ...
  - src/**tests**/unit/easy.recurringUtils.spec.ts (유닛 테스트)
...
- src/**tests**/unit/, src/**tests**/hooks/, src/**tests**/ 구조 파악
...
- src/**tests**/recurring-events.integration.spec.tsx 파일 생성
...
- src/**tests**/unit/easy.recurringUtils.spec.ts 파일 생성
- 36개 유닛 테스트 케이스 작성:
