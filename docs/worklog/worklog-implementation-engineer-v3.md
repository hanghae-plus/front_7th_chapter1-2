...
- 참고자료: src/**tests**/recurring-events.integration.spec.tsx, src/App.tsx
- 산출물: src/App.tsx, src/hooks/useEventForm.ts, src/**mocks**/handlersUtils.ts
