...
- 산출물:
  - src/__tests__/unit/easy.recurring-dates.spec.ts
  - src/__tests__/unit/easy.repeat-group-id.spec.ts
  - src/__tests__/unit/easy.repeat-text.spec.ts
  - src/__tests__/unit/medium.split-recurring-event.spec.ts
...
- .cursor/agents/engineers/qa-engineer/steps/classify-test-types.md
- docs/worklog/worklog-test-first-engineer-v2.md
- src/__tests__/unit/easy.eventUtils.spec.ts (유닛 테스트 예시)
