    ...
    <output>
      ...
      <template>
        ...
        <examples>
          <example>
            <value>
              .cursor/agents/engineers/refactoring-engineer/examples/refactor-good.md
            </value>
            <status>
              <ok>true</ok>
              <reason>
          ...
          <example>
            <value>
              .cursor/agents/engineers/refactoring-engineer/examples/refactor-bad.md
            </value>
            <status>
              <ok>false</ok>
              <reason>
    ...
    <output>
      ...
      <title>
        ...
        <examples>
          <example>
            <value>
              .cursor/agents/engineers/refactoring-engineer/examples/worklog-good.md
            </value>
            <status>
              <ok>true</ok>
              <reason>
