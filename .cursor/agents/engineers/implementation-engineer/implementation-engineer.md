    ...
    <output>
      ...
      <template>
        ...
        <examples>
          <example>
            <value>
              .cursor/agents/engineers/implementation-engineer/examples/template-good.md
            </value>
            <status>
              <ok>true</ok>
              <reason>
          ...
          <example>
            <value>
              .cursor/agents/engineers/implementation-engineer/examples/template-bad.md
            </value>
            <status>
              <ok>false</ok>
              <reason>
    ...
    <output>
      ...
      <template>
        ...
        <examples>
          ...
          <example>
            <value>
              .cursor/agents/engineers/implementation-engineer/examples/worklog-good-delegation.md
            </value>
            <status>
              <ok>true</ok>
              <reason>
