...
- **Specification**:
  - `.cursor/rules/calendar/artifacts/spec-writer/반복 일정 선택(생성:수정)_spec_20251029.md`
  - `.cursor/rules/calendar/artifacts/spec-writer/반복_일정_기능_PRD_v1.0.md`
...
**승인 후 저장 경로**: `.cursor/rules/calendar/artifacts/po/us001-recurring-event-selection.md`  
**예시**: 이미 저장되었습니다.
