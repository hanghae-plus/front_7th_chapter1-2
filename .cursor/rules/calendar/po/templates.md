...
**저장 위치**: `.cursor/rules/calendar/artifacts/po/`
...
**승인 후 저장 경로**: `.cursor/rules/calendar/artifacts/po/us###-[feature-name].md`
**예시**: `.cursor/rules/calendar/artifacts/po/us001-event-creation.md`
...
**승인 후 저장 경로**: `.cursor/rules/calendar/artifacts/po/epic###-[epic-name].md`
**예시**: `.cursor/rules/calendar/artifacts/po/epic001-calendar-system.md`
...
**승인 후 저장 경로**: `.cursor/rules/calendar/artifacts/po/ts###-[tech-task-name].md`
**예시**: `.cursor/rules/calendar/artifacts/po/ts001-state-management-refactor.md`
