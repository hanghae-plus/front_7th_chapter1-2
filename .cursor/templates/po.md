...
**저장 위치**: `.cursor/artifacts/po/`

**파일명 규칙**:

- User Story: `[기능명]_[단계].md` (예: `일정등록_story.md`)
- Epic: `[기능명]_[단계].md` (예: `일정등록_epic.md`)
- Technical Story: `[기능명]_[단계].md` (예: `[기능명]_refactor.md`)
...
**승인 후 저장 경로**: `.cursor/artifacts/po/[기능명]_[단계].md`
**예시**: `.cursor/artifacts/po/일정등록_story.md`
